...
const menuArrowClick = (e) => {
  e.target.parentElement.classList.toggle('_active')
}

const menuBurgerIconClick = () => {
    ...
    <header className="header">
      <div className="header__container container">
        ...
        <div className="header__menu">
          <div className="menu__icon" onClick={menuBurgerIconClick}>
            <span></span>
          </div>
          <nav className={"menu__body " + (isMobile.any() ? "menu__mobile" : "menu__desktop")}>
            <ul className="menu__list">
              <li>
                <NavLink className="menu__link" activeClassName="active" onClick={menuLinkClick}
                  to="/about">О нас</NavLink>
                <span className="menu__arrow" onClick={menuArrowClick}></span>
                <ul className="menu__sub-list">
                  <li>
                    <HashLink to="/about#mission" className="menu__sub-link" onClick={menuLinkClick}>Миссия</HashLink>
                  </li>
                  <li>
                    <HashLink to="/about#projects" className="menu__sub-link" onClick={menuLinkClick}>Проекты</HashLink>
                  </li>
                  <li>
                    <HashLink to="/about#team" className="menu__sub-link" onClick={menuLinkClick}>Команда</HashLink>
                  </li>
                  <li>
                    <HashLink to="/about#gratitudes" className="menu__sub-link" onClick={menuLinkClick}>Благодарности</HashLink>
                  </li>
                  <li>
                    <HashLink to="/about#requisites" className="menu__sub-link" onClick={menuLinkClick}>Реквизиты</HashLink>
                  </li>
                  <li>
