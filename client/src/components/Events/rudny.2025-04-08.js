  ...
  return (
    <div className="album">
      ...
      <div className="album__description">
        <p>
        8 апреля 2025 г. АНО ПСД "От сердца к сердцу" провели благотворительную акцию «Веселее жить, если добро творить!» для КОУ ВО «Руднянской школы-интернат для обучающихся с ограниченными возможностями здоровья».
        <br/>Ваша помощь была очень кстати, спасибо Вам огромное за это!
        <br/>Ваши усилия и доброта, вызывают неоценимые эмоции и уважение.
        <br/>Благодаря Вам, Вашей поддержки и трепетному отношению к происходящему, мы смогли преодолеть все преграды и успешно справиться с поставленной задачей.
        <br/>Спасибо!🤗
        </p>
      </div>
      <SRLWrapper>
