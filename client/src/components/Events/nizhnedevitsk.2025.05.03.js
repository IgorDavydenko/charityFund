  ...
  return (
    <div className="album">
      ...
      <div className="album__description">
        <p>
        03 мая 2025 г. АНО ПСД "От сердца к сердцу" провели благотворительную акцию «Этот мир мы дарим детям!» приуроченную к Международному дню защиты детей для КУ ВО «Нижнедевицкого социально-реабилитационного центра для несовершеннолетних».
        <br/>Особую признательность вызывает ваша готовность делиться не только материальными ресурсами, но и своим временем, энергией!
