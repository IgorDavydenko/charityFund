  ...
  return (
    <div className="album">
      ...
      <div className="album__description">
        <p>
        03 июня АНО ПСД "От сердца к сердцу" провели благотворительную акцию "Мир надежды!" для КУ ВО «Панинского социально-реабилитационного центра для несовершеннолетних».
        </p>
