  ...
  return (
    <div className="album">
      ...
      <div className="album__description">
        <p>
        02 августа АНО ПСД "От сердца к сердцу" провели благотворительную акцию "Надежда на будущее" для КУ ВО «Терновского социально-реабилитационного центра для несовершеннолетних». 
