...
const Album = () => {
  ...
  const data = {
    "photos": [
      "/img/albums/buturlinovka/2025-07-02/01.jpeg",
      "/img/albums/buturlinovka/2025-07-02/02.jpeg",
      "/img/albums/buturlinovka/2025-07-02/03.jpeg",
      "/img/albums/buturlinovka/2025-07-02/04.jpeg",
      "/img/albums/buturlinovka/2025-07-02/05.jpeg",
    ]
  };
  ...
  return (
    <div className="album">
      ...
      <div className="album__description">
        <p>
          02 июля 2025 г. АНО ПСД "От сердца к сердцу" провели благотворительную акцию «Мир начинается с детства!» для КОУ ВО «Бутурлиновской школы-интернат для обучающихся с ограниченными возможностями».
          <br/>Ваше доброе сердце и желание помогать делают этот мир лучше. Мы искренне ценим каждую Вашу заботу и поддержку!
          <br/>Спасибо за оказанное содействие!!!!🙏🙏🙏
        </p>
      </div>
