  ...
  return (
    <div className="album">
      ...
      <div className="album__description">
        <p>
        11 апреля АНО ПСД "От сердца к сердцу" провели благотворительную акцию "Доброе сердце" для КОУ ВО "Павловской школы-интернат номер 1 для обучающихся с ограниченными возможностями здоровья"
          <br/>Спасибо всем кто оказал помощь! Благодаря вам мы справились!
          <br/>Добрые дела не остаются не замеченными - они как маяки светят тем, кто ждёт помощи!
        </p>
      </div>
      <SRLWrapper>
        <div className="album__photos">
          <div className="photo__item">
            <img src='/img/albums/pavlovsk/01.jpg'/>
          </div>
          <div className="photo__item">
            <img src='/img/albums/pavlovsk/02.jpg'/>
          </div>
          <div className="photo__item">
            <img src='/img/albums/pavlovsk/03.jpg'/>
          </div>
        </div>
      </SRLWrapper>
    </div>
