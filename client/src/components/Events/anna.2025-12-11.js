...
const Album = () => {
  ...
  const data = {
    "photos": [
      "/img/albums/anna/2025-12-11/01.jpeg",
      "/img/albums/anna/2025-12-11/02.jpeg",
      "/img/albums/anna/2025-12-11/03.jpeg",
      "/img/albums/anna/2025-12-11/04.jpeg",
      "/img/albums/anna/2025-12-11/05.jpeg"
    ]
  };
  ...
  return (
    <div className="album">
      ...
      <div className="album__description">
        <p>
          11 декабря 2025 г. АНО ПСД "От сердца к сердцу" провели благотворительную акцию «Предновогодний марафон добра!» для КОУ ВО «Аннинской специальной общеобразовательной школы».
          <br/>Помощь детям-дело благородное и важное. Вы дарите малышам надежду, радость и веру в лучшее будущее.
          <br/>Благодарим всех неравнодушных людей, благодаря которым детская улыбка становится ярче, а мир добрее!
        </p>
      </div>
