  ...
  return (
    <div className="album">
      ...
      <div className="album__description">
        <p>
        05 декабря 2024 г. АНО ПСД "От сердца к сердцу" провели благотворительную акцию «Мир, в котором тебя любят!» для КОУ ВО «Аннинской специальной общеобразовательной школы».
        <br/>Ваши добрые дела-это луч света для тех, кто в них нуждается.
        <br/>Спасибо за ваше открытое сердце и желание помогать.
        <br/>Вы дарите людям надежду и веру в лучшее. Мы ценим вашу работу!
        </p>
      </div>
      <SRLWrapper>
        <div className="album__photos">
          <div className="photo__item">
            <img src='/img/albums/anna/2024-12-05/01.jpg'/>
          </div>
          <div className="photo__item">
            <img src='/img/albums/anna/2024-12-05/02.jpg'/>
          </div>
          <div className="photo__item">
            <img src='/img/albums/anna/2024-12-05/03.jpg'/>
          </div>
          <div className="photo__item">
            <img src='/img/albums/anna/2024-12-05/04.jpg'/>
          </div>
          <div className="photo__item">
            <img src='/img/albums/anna/2024-12-05/05.jpg'/>
          </div>
          <div className="photo__item">
            <img src='/img/albums/anna/2024-12-05/06.jpg'/>
          </div>
        </div>
      </SRLWrapper>
    </div>
