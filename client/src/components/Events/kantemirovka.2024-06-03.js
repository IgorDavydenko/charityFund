  ...
  return (
    <div className="album">
      ...
      <div className="album__description">
        <p>
          03 июня 2024 г. АНО ПСД "От сердца к сердцу" провели благотворительную акцию "Защита детей-забота взрослых" для КДОУ ВО «Кантемировского центра психолого-педагогической, медицинской и социальной помощи детям дошкольного возраста».
          <br/>Мир держится на неравнодушных, отзывчивых людях, не способных пройти мимо, всегда готовых помочь и оказать поддержку.
          <br/>Спасибо за оказанное воздействие, доверие, участие. Ваша помощь чрезвычайно ценна и никогда не будет забыта.🤗
        </p>
      </div>
      <SRLWrapper>
        <div className="album__photos">
          <div className="photo__item">
            <img src='/img/albums/kantemirovka/2024-06-03/01.jpg'/>
          </div>
          <div className="photo__item">
            <img src='/img/albums/kantemirovka/2024-06-03/02.jpg'/>
          </div>
          <div className="photo__item">
            <img src='/img/albums/kantemirovka/2024-06-03/03.jpg'/>
          </div>
          <div className="photo__item">
            <img src='/img/albums/kantemirovka/2024-06-03/04.jpg'/>
          </div>
          <div className="photo__item">
            <img src='/img/albums/kantemirovka/2024-06-03/05.jpg'/>
          </div>
          <div className="photo__item">
            <img src='/img/albums/kantemirovka/2024-06-03/06.jpg'/>
          </div>
          <div className="photo__item">
            <img src='/img/albums/kantemirovka/2024-06-03/07.jpg'/>
          </div>
        </div>
      </SRLWrapper>
    </div>
