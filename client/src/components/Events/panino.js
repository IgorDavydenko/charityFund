  ...
  return (
    <div className="album">
      ...
      <div className="album__description">
        <p>
          5 июля АНО ПСД "От сердца к сердцу" провели благотворительную акцию "Лучики добра" для КУ ВО "Панинского социально-реабилитационного центра для несовершеннолетних".
          <br/>Выражаем искреннюю благодарность всем кто участвовал!❤
