  ...
  return (
    <div className="album">
      ...
      <div className="album__description">
        <p>
          6 марта 2025 г. АНО ПСД "От сердца к сердцу" провели благотворительную акцию «Один за всех и все за одного!»  для КДОУ ВО «Кантемировского центра психолого-педагогической, медицинской и социальной помощи детям дошкольного возраста».
          ...
          <br/>Благодарим Вас за ваше доброе сердце.❤ Вы дарите силы справляться со всеми невзгодами. Будьте уверены, ваш труд не проходит даром.
